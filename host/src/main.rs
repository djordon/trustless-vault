...
fn main() {
    ...
    let verifying_key_1 = VerifyingKey::from(PublicKey::from_sec1_bytes(&signer_1).unwrap());
    let verifying_key_2 = VerifyingKey::from(PublicKey::from_sec1_bytes(&signer_2).unwrap());
    let verifying_key_3 = VerifyingKey::from(PublicKey::from_sec1_bytes(&signer_3).unwrap());
